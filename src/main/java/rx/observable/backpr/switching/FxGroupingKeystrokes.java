...
public final class FxGroupingKeystrokes extends Application {
	@Override
	public void start(Stage stage) throws Exception {
		...
		Observable<String> typedLetters = JavaFxObservable.eventsOf(scene, KeyEvent.KEY_TYPED)
				.map(KeyEvent::getCharacter).share();
		...
		// switchMap() each period of inactivity to an infinite scan() concatenating typed letters
