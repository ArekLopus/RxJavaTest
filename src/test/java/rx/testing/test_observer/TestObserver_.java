...
// await		awaitCount		awaitDone		awaitTerminalEvent	cancel			clearTimeout	completions		dispose
// errorCount	errors			getEvents		hasSubscription		lastThread		values			valueAndClass
public class TestObserver_ {
